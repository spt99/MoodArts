...
const product = {
  ...
  href: "#",
  breadcrumbs: [
    { id: 1, name: "Paintings", href: "#" },
    { id: 2, name: "CanvasPaintings", href: "#" },
  ],
  images: [
    {
      src: "https://tailwindui.com/img/ecommerce-images/product-page-02-secondary-product-shot.jpg",
      alt: "Two each of gray, white, and black FabricArt laying flat.",
    },
    {
      src: "https://tailwindui.com/img/ecommerce-images/product-page-02-tertiary-product-shot-01.jpg",
      alt: "Model with plain black background.",
    },
    {
      src: "https://tailwindui.com/img/ecommerce-images/product-page-02-tertiary-product-shot-02.jpg",
      alt: "plain gray bckground.",
    },
    {
      src: "https://tailwindui.com/img/ecommerce-images/product-page-02-featured-product-shot.jpg",
      alt: "plain white background.",
    },
  ],
  colors: [
  ...
  details:
    'The 6-Pack includes two black, two white. Sign up for our subscription service and be the first to get new, exciting works like famous artist limited release.',
};
          ...
          <div className="lg:col-span-1 mx-auto max-w-2xl px-4 pb-16 sm:px-6  lg:max-w-7xl  lg:px-8 lg:pb-24">
            <div className="lg:col-span-2">
              <h1 className="text-lg lg:text-xl font-semibold tracking-tight text-gray-900  ">
                {customersProduct.product?.Artist}
              </h1>
