...
export const findProducts = (reqData) => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await api.get(
      `/api/products?Base=${colors}&size=${sizes}&minPrice=${minPrice}&maxPrice=${maxPrice}&minDiscount=${minDiscount}&category=${category}&stock=${stock}&sort=${sort}&pageNumber=${pageNumber}&pageSize=${pageSize}`
    );
