  ...
  return (
    <Card>
       <CardHeader
          ...
          action={<Typography onClick={()=>navigate("/admin/products")} variant='caption' sx={{Base:"blue",cursor:"pointer",paddingRight:".8rem"}}>View All</Typography>}
          ...
          {dressPage1.slice(0,5).map((item,index) => (
            <TableRow hover key={item.name} sx={{ '&:last-of-type td, &:last-of-type th': { border: 0 } }}>
             <TableCell> <Avatar alt={item.title} src={item.imageUrl} /> </TableCell>
              ...
              <TableCell><Chip sx={{Base:"white"}} label="PLACED" size='small' Base="success" className='text-white' /></TableCell>
