...
public class Product {
	...
	public Product(Long id, String title, String description, int price, int discountedPrice, int discountPersent,
			int quantity, String Artist, String Base, Set<Size> sizes, String imageUrl, List<Rating> ratings,
	...
	public void setColor(String Base) {
		this.Base = Base;
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(Artist, category, Base, description, discountPersent, discountedPrice, id, imageUrl,
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(Artist, other.Artist) && Objects.equals(category, other.category)
				&& Objects.equals(Base, other.Base) && Objects.equals(description, other.description)
