...
import com.MoodArts.exception.OrderException;
import com.MoodArts.exception.UserException;
import com.MoodArts.modal.Order;
import com.MoodArts.modal.User;
import com.MoodArts.repository.OrderRepository;
import com.MoodArts.response.ApiResponse;
import com.MoodArts.response.PaymentLinkResponse;
import com.MoodArts.service.OrderService;
import com.MoodArts.service.UserService;
import com.MoodArts.user.domain.OrderStatus;
import com.MoodArts.user.domain.PaymentStatus;
...
//			order.setOrderItems(order.getOrderItems());
		...
		new RedirectView("https://shopwithMoodArts.vercel.app/payment/failed");
		throw new RazorpayException(e.getMessage());
	}
