...
import com.MoodArts.modal.Category;
import com.MoodArts.modal.Product;
import com.MoodArts.repository.CategoryRepository;
import com.MoodArts.repository.ProductRepository;
import com.MoodArts.request.CreateProductRequest;
import com.MoodArts.user.domain.ProductSubCategory;
...
public class ProductServiceImplementation implements ProductService {
	...
	public Product createProduct(CreateProductRequest req) {
		...
		product.setArtist(req.getArtist());
...
//		product.getCategory().
	...
	public Page<Product> getAllProduct(String category, List<String>colors, 
	    ...
	    return filteredProducts; // If Base list is empty, do nothing and return all products
